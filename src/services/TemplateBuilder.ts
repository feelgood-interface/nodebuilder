...
export class Builder {
	...
	resourceError(resourceName: string, options: { enabled: boolean } = { enabled: false }) {
	...
	operationDivider(resourceName: string, operationId: string, operationUrl: string) {
		return this.dividerBuilder.operationDivider(resourceName, operationId, operationUrl);
	}

	resourceDescriptionDivider(resourceName: string, operationId: string) {
		return this.dividerBuilder.resourceDescriptionDivider(resourceName, operationId);
	}
