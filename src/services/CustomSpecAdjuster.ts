...
export default class CustomSpecAdjuster {
	...
	private skipFields = ['endpoint', 'operationId', 'requestMethod', 'operationUrl'];
	...
	private separateKeys(obj: any) {
		Object.keys(obj).forEach((key) => {
			...
			if (this.isObjectArray(value)) value.forEach((i: object) => this.separateKeys(i));
	...
	private isSimpleType(value: string) {
		const simpleTypes = ['string', 'number', 'boolean', 'loadOptions', 'dateTime'];
